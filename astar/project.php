...
<section> 
 <nav class="navbar navbar-expand-lg navbar-dark  fixed-top">
  <div class="container-fluid ">
    <a class="navbar-brand" href="#">ASTAR INFOTECH</a>
      ...
      <div class="col-md-4">
        <div class="card testimonial border border-5">
          ...
          <div class="card-body test-body-block">
            ...
            <div class="card-subtitle mb-2 text-muted"><h5>CTO,Astar Infotech</h5></div>
      ...
      <div class="col-md-4">
        <div class="card testimonial  border-5">
          ...
          <div class="card-body test-body-block">
            ...
            <div class="card-subtitle mb-2 text-muted"><h5>Senior Developer,Astar Infotech</h5></div>
            <div class="test-text"> Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
            tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
            quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
            consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse
      ...
      <div class="col-md-4">
        <div class="card testimonial border-5">
          ...
          <div class="test-body-block card-body">
            ...
            <div class="card-subtitle mb-2 text-muted"><h5>CEO,Astar Infotech</h5></div>
            <div class="test-text"> Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
            tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
            quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
            consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse
...
<br>
    ...
    <form action="/astar/project.php" method="post" class="formcon">
...
<br>
 <section id="footer">
  <div class="c-footer" style="background-color: #000080">
    ...
    <a href="#intro" style="color: white" class="text-decoration-none">astarinfotech.com</a>
       </div>
